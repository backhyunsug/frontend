...
import BoardList2 from'./component/board2/board_list';
import BoardWrite2 from'./component/board2/board_write';
import BoardView2 from'./component/board2/board_view';


import MapMain from './component/map/mapmain';
    ...
    <div className="container">
      ...
      <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="board2/write" element={<BoardWrite2/>}/>
            <Route path="board2/view/:id" element={<BoardView2/>}/>
    ...
    <div >
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container-fluid">
          ...
          <li className="nav-item"><NavLink activestyle={activeStyle} className="nav-link" to="/board2">게시판2</NavLink></li>
          <li className="nav-item"><NavLink activestyle={activeStyle} className="nav-link" to="/map">지도</NavLink></li>
        </ul>
        </div>
      </nav>
