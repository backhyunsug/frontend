...
export default function MapMain() {
  ...
  return (
    <div className="App">
      ...
      <section>
        <button type="button" onClick={() => setMapSize([0, 0])}>Hide</button>
        <button type="button" onClick={() => setMapSize([200, 200])}>Resize (200x200)</button>
        <button type="button" onClick={() => setMapSize([400, 400])}>Resize (400x400)</button>
        <button type="button" onClick={() => setMapSize([600, 600])}>Resize (800x800)</button>
      </section>
      <section>
